...
CREATE TABLE `board` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_board_key_idx` (`writerId`),
  CONSTRAINT `user_board_key` FOREIGN KEY (`writerId`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2022-11-10 15:52:47
